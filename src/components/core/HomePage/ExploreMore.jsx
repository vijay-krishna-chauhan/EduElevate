...
//         </div>
//         <p className='font-sm text-richblack-300 text-[16px] mt-3 text-center'>Learn to build anything you can imagine </p>

//         <div className='flex flex-row bg-richblack-800 rounded-full mt-5 mb-5 border-richblack-100 px-1 py-1'>
//             {
